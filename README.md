...
De gedeelde online sync bewaart vinkjes, datum, uur, plaats, coördinaten, notitie en foto's. Foto's gaan naar een private Supabase Storage bucket `bird-photos` en zijn alleen zichtbaar voor de eigenaar en gekoppelde partner.
